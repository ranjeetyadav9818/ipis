...
public class TestBoardLedTestingController  {
	...
	@Test
	public void testCreateBoardLedTesting() {
		CoachData coachdata = new CoachData();
		coachdata.setCreatedAt(null);
		coachdata.setCreatedBy("admin");
		ResponseEntity<CoachData> postResponse = restTemplate.postForEntity("/led", coachdata, CoachData.class);
