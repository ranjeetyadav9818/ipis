...
import com.innobitsysytems.ipis.services.announcement.AnnouncementService;
	...
	public class TestBoardSettingController  {
		...
		@Test
		public void testGetAllBoardSetting() {
			HttpHeaders headers = new HttpHeaders();
			HttpEntity<String> entity = new HttpEntity<String>(null, headers);
			ResponseEntity<String> response = restTemplate.exchange( "/boardset",
					HttpMethod.GET, entity, String.class);
			Assert.assertNotNull(response.getBody());
		}

		@Test
		public void testGetBoardSettingById() {
			BoardSetting boardsetting = restTemplate.getForObject("/boardset/-1", BoardSetting.class);
			Assert.assertNotNull(boardsetting);
		}

		@Test
		public void testCreateBoardSetting() {
			BoardSetting boardsetting = new BoardSetting();
			boardsetting.setCreatedAt(null);
			boardsetting.setCreatedBy("admin");
			ResponseEntity<BoardSetting> postResponse = restTemplate.postForEntity("/boardset", boardsetting, BoardSetting.class);
