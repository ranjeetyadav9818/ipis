...
@Entity
@Table(name="schedulestoarriveAnnouncement")
@EntityListeners(AuditingEntityListener.class)

public class SchedulesToArriveAt {
	...
	public String toString() {
		return "SchedulesToArriveAt [id=" + id + ", language=" + language + ", audioFile=" + audioFile + ", createdAt="
